...
const Theme1Footer = ({ currentTheme = "theme1" }) => {
  ...
  const academyName = !isMainSite && agency?.name ? agency.name : "AI Courses";
          ...
          >
            ...
            {supportEmail && (
              <div className="flex items-center gap-2 mt-1.5 text-xs text-slate-400 font-medium">
                ...
                <a href={`mailto:${supportEmail}`} className="hover:text-cyan-400 transition-colors">{supportEmail}</a>
              </div>
            )}
          </motion.div>
          ...
          >
            <div className="bg-slate-900/70 border border-slate-800/90 rounded-2xl p-5 sm:p-6 relative overflow-hidden group shadow-lg backdrop-blur-md">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md shadow-blue-500/25 cursor-pointer relative z-10 text-xs sm:text-sm active:scale-98"
              >
                  ...
                  <li key={i}>
                    ...
                    >
                      <span className="relative flex items-center gap-1.5">
                        ...
                        {link.name}
                        <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-cyan-400 transition-all group-hover:w-full"></span>
                      </span>
                    </a>
                  </li>
                ))}
