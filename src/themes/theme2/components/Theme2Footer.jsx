...
const SocialIcon = ({ Icon, href }) => (
  <motion.a
    ...
    whileHover={{
      ...
      color: "#ffffff",
      borderColor: "var(--brand-color, #6366f1)",
    }}
    whileTap={{ scale: 0.9 }}
...
const Theme2Footer = ({ currentTheme = "theme2" }) => {
        ...
        <div className="space-y-5 text-slate-300 text-sm md:text-base leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              <a href={`mailto:${supportEmail}`} className="text-purple-400 hover:underline">{supportEmail}</a> or WhatsApp us at{" "}
              <a href={whatsappLink} className="text-purple-400 hover:underline">{supportPhone}</a>.
            </p>
          </section>
        </div>
      ),
  ...
  return (
    <footer className="relative bg-[#061129] text-white pt-10 sm:pt-14 pb-20 lg:pb-10 overflow-hidden font-roboto-condensed border-t border-slate-800/80">
      <div className="absolute top-0 left-0 size-160 bg-purple-600/10 rounded-full blur-[100px] pointer-events-none -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 size-120 bg-pink-500/10 rounded-full blur-[90px] pointer-events-none translate-x-1/3 translate-y-1/3" />
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 mb-10 pb-8 border-b border-slate-800/60">
          ...
          >
            <div className="flex items-center gap-2.5 mb-4">
              <div className="size-9 sm:size-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center shadow-md shadow-purple-500/30">
            ...
            <h3 className="text-2xl sm:text-3xl font-extrabold text-white mb-3 leading-tight tracking-tight">
              ...
              <span className="text-purple-400">mastering AI Video Creation</span>.
            </h3>
          ...
          >
            <div className="bg-slate-900/70 border border-slate-800/90 rounded-2xl p-5 sm:p-6 relative overflow-hidden group shadow-lg backdrop-blur-md">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-500 hover:to-pink-400 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md shadow-purple-500/25 cursor-pointer relative z-10 text-xs sm:text-sm active:scale-98"
              >
                  ...
                  <li key={i}>
                    <a
                      ...
                      className={`group flex items-center gap-2 transition-colors text-xs sm:text-sm font-medium ${
                        link.isPartner || link.type
                          ? "text-purple-400 hover:text-purple-300 font-bold cursor-pointer"
                    ...
                    >
                      <span className="relative flex items-center gap-1.5">
                        ...
                        {link.name}
                        <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-purple-400 transition-all group-hover:w-full"></span>
                      </span>
                    </a>
                  </li>
                ))}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-6 border-t border-slate-800/60 gap-4 text-xs sm:text-sm">
          ...
          <div className="flex items-center gap-1.5 text-slate-400 font-medium">
            ...
            <span>by</span>
            <a href="https://www.codewebx.in/" target="_blank" rel="noreferrer" className="text-purple-400 hover:text-purple-300 transition-colors font-bold">
              CodeWebX
            </a>
          </div>
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0, y: 15 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.95, opacity: 0, y: 15 }} className="relative w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
              <div className="flex items-center justify-between p-5 sm:p-6 border-b border-slate-800 bg-slate-900/50 backdrop-blur-xl z-10">
                ...
                <button onClick={() => setActivePolicy(null)} className="size-8 rounded-full bg-slate-800 text-slate-400 flex items-center justify-center hover:bg-purple-600 hover:text-white transition-colors cursor-pointer">
                  <X className="size-4" />
                </button>
              </div>
